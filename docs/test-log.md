...
> **Thuộc file này:** kết quả từng lượt test **P0–P33** (nhánh `master`) — chạy gì, ra sao, tìm được lỗi nào.
> Chi tiết từng lỗi nằm ở file phân loại tương ứng, đây chỉ ghi lượt test và kết luận.
> Các lượt **P34 trở đi** (nhánh `version2`) nằm ở [test-log-v2.md](./test-log-v2.md).
